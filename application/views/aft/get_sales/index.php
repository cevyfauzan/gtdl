        ...
        <div class="box box-primary">
			<div class="box-header">
				...
				<div class="pull-right">
                    <a href="" class="btn btn-success btn-sm" data-toggle="modal" data-target="#add-phones" title="Add"><i class="fa fa-plus"></i>&ensp;Add New Sales</a>
				</div>
            </div>
            <div class="box-body">
...
<script>
	...
	function nav_active(){
		document.getElementById("aft-s").className = "active";
	}
